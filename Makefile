...
kernel: kernel.o main.o conio.o gdt.o idt.o ient.o pic.o pit.o keybd.o tss.o sched.o cont.o user.o syscall.o proc.o cmos.o mm/mmu.o mm/mman.o mm/mallo.o mm/vmm.o mm/pmm.o blk_drv/ide.o fs/buffer.o fs/rwblk.o fs/super.o fs/inode.o fs/dir.o fs/path.o fs/namei.o fs/blkrw.o fs/exec.o misc/misc.a
	@echo + [ld] $@
