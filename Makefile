...
kernel: kernel.o main.o console.o gdt.o idt.o ient.o pic.o pit.o keybd.o tss.o mm/mmu.o mm/mman.o mm/mallo.o sched.o cont.o user.o syscall.o proc.o cmos.o misc/vsprintf.o misc/sprintf.o misc/printk.o misc/cprintf.o misc/memcpy.o misc/strcmp.o misc/strchr.o blk_drv/ide.o fs/buffer.o fs/rwblk.o fs/super.o fs/inode.o fs/dir.o fs/path.o fs/namei.o fs/blkrw.o
	@echo + [ld] $@
